...
    "Get all projects in the current workspace. Returns project ID, name, status, customer, and k
    async (args) =>
    {
...
        {
            ["take"] = new JObject { ["type"] = "integer", ["description"] = "Maximum number of p
        }
    });

server.RegisterTool("CreateProject",
    "Create a new project in the workspace. Requires name and optionally customer ID, dates, and
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["name"] = new JObject { ["type"] = "string", ["description"] = "Project name" },
            ["customerId"] = new JObject { ["type"] = "integer", ["description"] = "Customer ID t
            ["startDate"] = new JObject { ["type"] = "string", ["format"] = "date", ["description
            ["endDate"] = new JObject { ["type"] = "string", ["format"] = "date", ["description"]
        },
        ["required"] = new JArray { "name" }
    });

server.RegisterTool("GetProjectDetails",
    "Get detailed information about a specific project including tasks, team members, and statist
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["projectId"] = new JObject { ["type"] = "integer", ["description"] = "The project ID
        },
...
    "List all API keys in the workspace. Shows name, key prefix, scopes, last usage, and status."
    async (args) =>
    {
...
server.RegisterTool("GetApiKeyScopes",
    "Get all available API key scopes with descriptions. Use this to understand what permissions
    async (args) =>
    {
...
    "Create a new API key with specified name and scopes. Returns the full key only once - save i
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["name"] = new JObject { ["type"] = "string", ["description"] = "Name for the API key
            ["scopes"] = new JObject { ["type"] = "array", ["items"] = new JObject { ["type"] = "
            ["expiresInDays"] = new JObject { ["type"] = "integer", ["description"] = "Days until
        },
        ["required"] = new JArray { "name", "scopes" }
    });

server.RegisterTool("RevokeApiKey",
...
        ["properties"] = new JObject
        {
            ["apiKeyId"] = new JObject { ["type"] = "integer", ["description"] = "The API key ID
        },
        ["required"] = new JArray { "apiKeyId" }
    });
...
    "List all dashboards in the workspace. Shows name, widget count, scope, and default status.",
    async (args) =>
    {
...
    "Get detailed information about a dashboard including all widgets, positions, and configurati
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["dashboardId"] = new JObject { ["type"] = "integer", ["description"] = "The dashboar
        },
        ["required"] = new JArray { "dashboardId" }
    });

server.RegisterTool("CreateDashboard",
    "Create a new dashboard with optional widgets configuration. Can be personal or workspace-sco
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["name"] = new JObject { ["type"] = "string", ["description"] = "Dashboard name" },
            ["description"] = new JObject { ["type"] = "string", ["description"] = "Optional desc
            ["theme"] = new JObject { ["type"] = "string", ["enum"] = new JArray { "light", "dark
            ["refreshIntervalSeconds"] = new JObject { ["type"] = "integer", ["description"] = "A
            ["scope"] = new JObject { ["type"] = "string", ["enum"] = new JArray { "Personal", "W
        },
        ["required"] = new JArray { "name" }
    });

server.RegisterTool("UpdateDashboard",
    "Update dashboard properties like name, description, theme, or refresh interval.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
        ["properties"] = new JObject
        {
            ["dashboardId"] = new JObject { ["type"] = "integer", ["description"] = "Dashboard ID
            ["name"] = new JObject { ["type"] = "string", ["description"] = "New name" },
            ["description"] = new JObject { ["type"] = "string", ["description"] = "New descripti
            ["theme"] = new JObject { ["type"] = "string", ["description"] = "New theme" },
            ["refreshIntervalSeconds"] = new JObject { ["type"] = "integer", ["description"] = "N
        },
        ["required"] = new JArray { "dashboardId" }
    });

server.RegisterTool("DeleteDashboard",
    "Permanently delete a dashboard and all its widgets. This action cannot be undone.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
server.RegisterTool("SetDefaultDashboard",
    "Set a dashboard as the default for the current user. This dashboard will load first.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
server.RegisterTool("DuplicateDashboard",
    "Create a copy of an existing dashboard with all its widgets and configuration.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
        {
            ["dashboardId"] = new JObject { ["type"] = "integer", ["description"] = "Dashboard ID
            ["newName"] = new JObject { ["type"] = "string", ["description"] = "Name for the new
        },
        ["required"] = new JArray { "dashboardId" }
    });
...
server.RegisterTool("GetWidgets",
    "List all widgets on a dashboard with their types, titles, positions, and sizes.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
server.RegisterTool("GetWidgetDetails",
    "Get full details of a widget including configuration, datasource settings, and styling.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
        {
            ["dashboardId"] = new JObject { ["type"] = "integer", ["description"] = "Dashboard ID
            ["widgetId"] = new JObject { ["type"] = "integer", ["description"] = "Widget ID to re
        },
        ["required"] = new JArray { "dashboardId", "widgetId" }
    });

server.RegisterTool("CreateWidget",
    "Add a new widget to a dashboard. Supports various types: chart, stat, table, list, etc.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
        return ResponseFormatter.CreatedDa("Widget", widget.Id, $"{widget.Title} ({widget.TypeNam
    },
    new JObject
    {
        ["type"] = "object",
...
        {
            ["dashboardId"] = new JObject { ["type"] = "integer", ["description"] = "Dashboard ID
            ["type"] = new JObject { ["type"] = "string", ["description"] = "Widget type (chart,
            ["title"] = new JObject { ["type"] = "string", ["description"] = "Widget title" },
            ["subtitle"] = new JObject { ["type"] = "string", ["description"] = "Optional subtitl
            ["icon"] = new JObject { ["type"] = "string", ["description"] = "Optional icon name"
            ["gridX"] = new JObject { ["type"] = "integer", ["description"] = "Grid X position (d
            ["gridY"] = new JObject { ["type"] = "integer", ["description"] = "Grid Y position (d
            ["gridWidth"] = new JObject { ["type"] = "integer", ["description"] = "Width in grid
            ["gridHeight"] = new JObject { ["type"] = "integer", ["description"] = "Height in gri
            ["config"] = new JObject { ["type"] = "object", ["description"] = "Widget-specific co
            ["datasourceConfig"] = new JObject { ["type"] = "object", ["description"] = "Data sou
        },
        ["required"] = new JArray { "dashboardId", "type", "title" }
    });

server.RegisterTool("UpdateWidget",
    "Update widget properties, position, size, or configuration.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
        var widgetId = args.GetRequiredInt("widgetId");
...
        {
            ["dashboardId"] = new JObject { ["type"] = "integer", ["description"] = "Dashboard ID
            ["widgetId"] = new JObject { ["type"] = "integer", ["description"] = "Widget ID to up
            ["title"] = new JObject { ["type"] = "string", ["description"] = "New title" },
            ["subtitle"] = new JObject { ["type"] = "string", ["description"] = "New subtitle" },
            ["gridX"] = new JObject { ["type"] = "integer", ["description"] = "New X position" },
            ["gridY"] = new JObject { ["type"] = "integer", ["description"] = "New Y position" },
            ["gridWidth"] = new JObject { ["type"] = "integer", ["description"] = "New width" },
            ["gridHeight"] = new JObject { ["type"] = "integer", ["description"] = "New height" }
            ["config"] = new JObject { ["type"] = "object", ["description"] = "Updated configurat
        },
        ["required"] = new JArray { "dashboardId", "widgetId" }
    });

server.RegisterTool("DeleteWidget",
    "Remove a widget from a dashboard. This action cannot be undone.",
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
        var widgetId = args.GetRequiredInt("widgetId");
...
        {
            ["dashboardId"] = new JObject { ["type"] = "integer", ["description"] = "Dashboard ID
            ["widgetId"] = new JObject { ["type"] = "integer", ["description"] = "Widget ID to de
        },
        ["required"] = new JArray { "dashboardId", "widgetId" }
    });

server.RegisterTool("UpdateWidgetLayout",
    "Batch update positions and sizes for multiple widgets at once. Use for drag-drop rearrangeme
    async (args) =>
    {
        var dashboardId = args.GetRequiredInt("dashboardId");
...
            {
                ["type"] = "array",
                ["description"] = "Array of widget layout updates",
                ["items"] = new JObject
                {
                    ["type"] = "object",
                    ["properties"] = new JObject
                    {
                        ["widgetId"] = new JObject { ["type"] = "integer" },
                        ["gridX"] = new JObject { ["type"] = "integer" },
                        ["gridY"] = new JObject { ["type"] = "integer" },
                        ["gridWidth"] = new JObject { ["type"] = "integer" },
                        ["gridHeight"] = new JObject { ["type"] = "integer" }
                    }
                }
            }
        },
        ["required"] = new JArray { "dashboardId", "layouts" }
    });
...
server.RegisterTool("GetDatasourceEntities",
    "List all queryable entities (tables/views) in the workspace. Optionally filter by category."
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["category"] = new JObject { ["type"] = "string", ["description"] = "Filter by catego
        }
    });

server.RegisterTool("GetEntitySchema",
    "Get the schema (fields, relations, capabilities) for a specific entity. Essential for buildi
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["entityName"] = new JObject { ["type"] = "string", ["description"] = "Name of the en
        },
        ["required"] = new JArray { "entityName" }
    });

server.RegisterTool("ExecuteDatasourceQuery",
    "Execute a custom query against workspace data. Supports fields, filters, sorting, grouping,
    async (args) =>
    {
...
        sb.AppendLine($"Query resultat: {result.Meta?.ReturnedCount} / {result.Meta?.TotalCount}
...
            {
                var values = result.Meta.Columns.Select(c => row.TryGetValue(c.Name, out var v) ?
...
        ["properties"] = new JObject
        {
            ["entity"] = new JObject { ["type"] = "string", ["description"] = "Entity name to que
            ["limit"] = new JObject { ["type"] = "integer", ["description"] = "Max rows to return
            ["offset"] = new JObject { ["type"] = "integer", ["description"] = "Number of rows to
            ["fields"] = new JObject { ["type"] = "array", ["description"] = "Fields to select",
            ["filters"] = new JObject { ["type"] = "array", ["description"] = "Filter conditions"
            ["sorting"] = new JObject { ["type"] = "array", ["description"] = "Sort order", ["ite
            ["groupBy"] = new JObject { ["type"] = "array", ["description"] = "Group by fields",
            ["aggregations"] = new JObject { ["type"] = "array", ["description"] = "Aggregation f
        },
        ["required"] = new JArray { "entity" }
    });

server.RegisterTool("PreviewDatasourceQuery",
    "Quick preview of data from an entity without full query specification. Good for exploring da
    async (args) =>
    {
        var entity = args.GetRequiredString("entity");
...
        ["properties"] = new JObject
        {
            ["entity"] = new JObject { ["type"] = "string", ["description"] = "Entity name to pre
            ["maxRows"] = new JObject { ["type"] = "integer", ["description"] = "Max rows to prev
        },
        ["required"] = new JArray { "entity" }
    });

server.RegisterTool("ValidateDatasourceQuery",
    "Validate a query without executing it. Returns errors if the query is invalid.",
    async (args) =>
    {
        var entity = args.GetRequiredString("entity");
        var query = client.Datasource.CreateQuery(entity);
...
        ["properties"] = new JObject
        {
            ["entity"] = new JObject { ["type"] = "string", ["description"] = "Entity name to val
        },
        ["required"] = new JArray { "entity" }
    });

server.RegisterTool("GetDatasourceCategories",
    "List all entity categories available for querying. Use to understand data organization.",
    async (args) =>
    {
...
    "List tasks in the workspace or for a specific project. Supports filtering by completion stat
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["projectId"] = new JObject { ["type"] = "integer", ["description"] = "Filter by proj
            ["includeCompleted"] = new JObject { ["type"] = "boolean", ["description"] = "Include
            ["limit"] = new JObject { ["type"] = "integer", ["description"] = "Max tasks to retur
        }
    });

server.RegisterTool("GetTaskDetails",
    "Get full details of a task including description, assignee, progress, and time estimates.",
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["taskId"] = new JObject { ["type"] = "integer", ["description"] = "Task ID to retrie
        },
        ["required"] = new JArray { "taskId" }
    });

server.RegisterTool("CreateTask",
    "Create a new task in a project. Supports priority, due date, assignment, and time estimates.
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["name"] = new JObject { ["type"] = "string", ["description"] = "Task name" },
            ["projectId"] = new JObject { ["type"] = "integer", ["description"] = "Project to cre
            ["description"] = new JObject { ["type"] = "string", ["description"] = "Task descript
            ["assignedTo"] = new JObject { ["type"] = "integer", ["description"] = "User ID to as
            ["priority"] = new JObject { ["type"] = "string", ["enum"] = new JArray { "Low", "Nor
            ["dueDate"] = new JObject { ["type"] = "string", ["format"] = "date", ["description"]
            ["estimatedHours"] = new JObject { ["type"] = "number", ["description"] = "Estimated
        },
        ["required"] = new JArray { "name", "projectId" }
    });

server.RegisterTool("UpdateTask",
    "Update task properties including name, description, status, priority, or assignment.",
    async (args) =>
    {
        var taskId = args.GetRequiredInt("taskId");
...
        ["properties"] = new JObject
        {
            ["taskId"] = new JObject { ["type"] = "integer", ["description"] = "Task ID to update
            ["name"] = new JObject { ["type"] = "string", ["description"] = "New name" },
            ["description"] = new JObject { ["type"] = "string", ["description"] = "New descripti
            ["status"] = new JObject { ["type"] = "string", ["enum"] = new JArray { "NotStarted",
            ["priority"] = new JObject { ["type"] = "string", ["enum"] = new JArray { "Low", "Nor
            ["assignedTo"] = new JObject { ["type"] = "integer", ["description"] = "New assignee
            ["progress"] = new JObject { ["type"] = "number", ["description"] = "Progress percent
        },
        ["required"] = new JArray { "taskId" }
    });
...
        ["properties"] = new JObject
        {
            ["taskId"] = new JObject { ["type"] = "integer", ["description"] = "Task ID to delete
        },
        ["required"] = new JArray { "taskId" }
    });

server.RegisterTool("UpdateTaskStatus",
    "Quickly change a task's status without updating other fields.",
    async (args) =>
    {
        var taskId = args.GetRequiredInt("taskId");
...
            ["status"] = new JObject { ["type"] = "string", ["enum"] = new JArray { "NotStarted",
        },
        ["required"] = new JArray { "taskId", "status" }
    });
...
    "List time registrations. Filter by date range or project. Shows hours, project, task, and bi
    async (args) =>
    {
...
        {
            registrations = await client.TimeRegistrations.GetByDateRangeAsync(startDate.Value, e
        }
        else if (projectId.HasValue)
        {
            registrations = await client.TimeRegistrations.GetByProjectAsync(projectId.Value, lim
        }
        else
        {
            var query = new Served.SDK.Models.TimeRegistration.TimeRegistrationQueryParams { Take
...
        ["properties"] = new JObject
        {
            ["startDate"] = new JObject { ["type"] = "string", ["format"] = "date-time", ["descri
            ["endDate"] = new JObject { ["type"] = "string", ["format"] = "date-time", ["descript
            ["projectId"] = new JObject { ["type"] = "integer", ["description"] = "Filter by proj
            ["limit"] = new JObject { ["type"] = "integer", ["description"] = "Max registrations
        }
    });

server.RegisterTool("CreateTimeRegistration",
    "Register time worked on a project or task. Supports hours/minutes, billable flag, and descri
    async (args) =>
    {
        var start = args.GetOptionalDateTime("start") ?? args.GetOptionalDateTime("date") ?? Date
...
        ["properties"] = new JObject
        {
            ["projectId"] = new JObject { ["type"] = "integer", ["description"] = "Project ID to
            ["taskId"] = new JObject { ["type"] = "integer", ["description"] = "Task ID to regist
            ["start"] = new JObject { ["type"] = "string", ["format"] = "date-time", ["descriptio
            ["end"] = new JObject { ["type"] = "string", ["format"] = "date-time", ["description"
            ["hours"] = new JObject { ["type"] = "number", ["description"] = "Hours worked (alter
            ["minutes"] = new JObject { ["type"] = "integer", ["description"] = "Minutes worked"
            ["description"] = new JObject { ["type"] = "string", ["description"] = "Work descript
            ["billable"] = new JObject { ["type"] = "boolean", ["description"] = "Is this time bi
        }
    });

server.RegisterTool("UpdateTimeRegistration",
    "Update an existing time registration - change times, project, task, or billable status.",
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["id"] = new JObject { ["type"] = "integer", ["description"] = "Time registration ID
            ["projectId"] = new JObject { ["type"] = "integer", ["description"] = "New project ID
            ["taskId"] = new JObject { ["type"] = "integer", ["description"] = "New task ID" },
            ["start"] = new JObject { ["type"] = "string", ["format"] = "date-time", ["descriptio
            ["end"] = new JObject { ["type"] = "string", ["format"] = "date-time", ["description"
            ["description"] = new JObject { ["type"] = "string", ["description"] = "New descripti
            ["billable"] = new JObject { ["type"] = "boolean", ["description"] = "Update billable
        },
        ["required"] = new JArray { "id" }
    });

server.RegisterTool("DeleteTimeRegistration",
    "Delete a time registration. This action cannot be undone.",
    async (args) =>
    {
        var id = args.GetRequiredInt("id");
...
    "List customers in the workspace. Supports search by name/email/phone.",
    async (args) =>
    {
...
        ["properties"] = new JObject
        {
            ["search"] = new JObject { ["type"] = "string", ["description"] = "Search query to fi
            ["limit"] = new JObject { ["type"] = "integer", ["description"] = "Max customers to r
        }
    });

server.RegisterTool("GetCustomerDetails",
    "Get full details for a customer including contact info, address, and VAT number.",
    async (args) =>
    {
...
server.RegisterTool("GetActiveAgents",
    "Discover active AI agents in the workspace. Filter by status, type, or online state. Essenti
    async (args) =>
    {
...
        var response = await server.Http.PostAsJsonAsync("/api/agents/coordination/GetActiveAgent
...
        ["properties"] = new JObject
        {
            ["status"] = new JObject { ["type"] = "string", ["enum"] = new JArray { "Active", "Id
            ["agentType"] = new JObject { ["type"] = "string", ["description"] = "Filter by agent
            ["isOnline"] = new JObject { ["type"] = "boolean", ["description"] = "Filter by onlin
        }
    });

server.RegisterTool("GetAgentContext",
    "Get detailed context for a specific agent including active files, todos, git state, and rece
    async (args) =>
    {
        var agentId = args["agentId"]?.Value<int>() ?? throw new ArgumentException("agentId requi

        var response = await server.Http.PostAsJsonAsync($"/api/agents/coordination/GetAgentConte
...
        {
            sb.AppendLine($"    [{action["timestamp"]}] {action["actionType"]}: {action["descript
        }
        sb.AppendLine("  }");
...
        ["properties"] = new JObject
        {
            ["agentId"] = new JObject { ["type"] = "integer", ["description"] = "Agent ID to get
        },
        ["required"] = new JArray { "agentId" }
    });

server.RegisterTool("SearchAgentActivity",
    "Search across all agent activities for specific patterns or keywords. Great for debugging.",
    async (args) =>
    {
        var query = args["query"]?.Value<string>() ?? throw new ArgumentException("query required
        var limit = args["limit"]?.Value<int>() ?? 20;

        var response = await server.Http.PostAsJsonAsync($"/api/agents/coordination/SearchActivit
            new StringContent("{}", Encoding.UTF8, "application/json"));
...
{
    var response = await server.Http.PostAsJsonAsync("/api/agents/coordination/GetCoordinationInf
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
    foreach (var agent in agents)
    {
        sb.AppendLine($"  - Agent #{agent["agentId"]} ({agent["agentName"]}): {agent["status"]} -
    }
    sb.AppendLine();
...
    {
        sb.AppendLine($"  - Task {task["taskId"]} -> Agent #{task["agentId"]} ({task["agentName"]
    }
    sb.AppendLine();
...
        {
            sb.AppendLine($"  - [{conflict["severity"]}] {conflict["type"]}: {conflict["descripti
            sb.AppendLine($"    Agents: {string.Join(", ", (conflict["agentIds"] as JArray ?? new
        }
    }
    else
    {
...
{
    var fromAgentId = args["fromAgentId"]?.Value<int>() ?? throw new ArgumentException("fromAgent
    var targetAgentId = args["targetAgentId"]?.Value<int>() ?? throw new ArgumentException("targe
...
    var response = await server.Http.PostAsJsonAsync($"/api/agents/coordination/Coordinate?fromAg
...
        sb.AppendLine($"    Operation: {file["operation"]} by Agent #{file["agentId"]} ({file["ag
...
            sb.AppendLine($"    capabilities: [{string.Join(", ", (integration["capabilities"] as
...
    if (!string.IsNullOrEmpty(category)) queryParams.Add($"category={Uri.EscapeDataString(categor
...
        sb.AppendLine($"  status: {statusIcon} {(status?["isConnected"]?.Value<bool>() == true ?
...
{
    var handlerId = args["handlerId"]?.Value<int>() ?? throw new ArgumentException("handlerId req
...
    var response = await server.Http.PostAsJsonAsync($"/api/integrations/handlers/{handlerId}/tes
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
            sb.AppendLine($"    Calls: {item["calls"]}, Success Rate: {item["successRate"] ?? 0:P
...
{
    var integrationId = args["integrationId"]?.Value<string>() ?? throw new ArgumentException("in
...
            sb.AppendLine($"    {field["name"]}{required} ({field["fieldType"]}): \"{field["displ
            if (field["description"] != null)
                sb.AppendLine($"      // {field["description"]}");
            if (field["options"] is JArray options && options.Count > 0)
            {
                sb.AppendLine($"      Options: [{string.Join(", ", options.Select(o => o["value"]
            }
        }
        sb.AppendLine();
    }
...
    var response = await server.Http.PostAsJsonAsync($"/api/integrations/handlers/{handlerId}/dea
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
    var queryParams = new List<string>();
    if (!string.IsNullOrEmpty(integrationType)) queryParams.Add($"integrationType={Uri.EscapeData
    if (onlyActive) queryParams.Add("onlyActive=true");
    if (queryParams.Count > 0) url += "?" + string.Join("&", queryParams);
...
            sb.AppendLine($"    status: {statusIcon} {(conn["isConnected"]?.Value<bool>() == true
...
{
    var connectionId = args["connectionId"]?.Value<int>() ?? throw new ArgumentException("connect
...
    var response = await server.Http.PostAsJsonAsync($"/api/infrastructure/connections/{connectio
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
    if (!string.IsNullOrEmpty(resourceType)) queryParams.Add($"resourceType={Uri.EscapeDataString
...
            {
                var memUsedGb = (res["memoryUsed"]?.Value<long>() ?? 0) / 1024.0 / 1024.0 / 1024.
                var memTotalGb = (res["memoryBytes"]?.Value<long>() ?? 0) / 1024.0 / 1024.0 / 102
...
{
    var resourceId = args["resourceId"]?.Value<int>() ?? throw new ArgumentException("resourceId
...
    {
        var uptime = TimeSpan.FromSeconds(res["uptime"]?.Value<long>() ?? 0);
        sb.AppendLine($"  uptime: {uptime.Days}d {uptime.Hours}h {uptime.Minutes}m {uptime.Second
    }
    sb.AppendLine();
...
    var response = await server.Http.PostAsJsonAsync($"/api/infrastructure/resources/{resourceId}
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
    var result = JObject.Parse(await response.Content.ReadAsStringAsync());
    return $"⏹ Resource {resourceId} stop initiated{(force ? " (forced)" : "")}. Task ID: {result
});
...
    url += $"?startDate={startDate:yyyy-MM-ddTHH:mm:ss}Z&endDate={endDate:yyyy-MM-ddTHH:mm:ss}Z&r
...
        sb.AppendLine($"  Memory: avg {avgMem / 1024.0 / 1024.0 / 1024.0:F2} GB, max {maxMem / 10
        sb.AppendLine();
...
            sb.AppendLine($"  [{ts:HH:mm}] CPU: {m["cpuUsage"] ?? 0:F1}% | " +
                         $"Mem: {(m["memoryUsed"]?.Value<long>() ?? 0) / 1024.0 / 1024.0 / 1024.0
                         $"Net In/Out: {(m["networkIn"]?.Value<long>() ?? 0) / 1024.0:F0}/{(m["ne
        }
    }
    else
    {
...
    var response = await server.Http.GetAsync($"/api/infrastructure/resources/{resourceId}/snapsh
    if (!response.IsSuccessStatusCode)
...
{
    var resourceId = args["resourceId"]?.Value<int>() ?? throw new ArgumentException("resourceId
    var snapshotName = args["snapshotName"]?.Value<string>() ?? throw new ArgumentException("snap
...
    var result = JObject.Parse(await response.Content.ReadAsStringAsync());
    return $"⏪ Restoring snapshot '{snapshotName}' for resource {resourceId}. Task ID: {result["
});

server.RegisterTool("LinkResourceToProject", async (args) =>
{
    var resourceId = args["resourceId"]?.Value<int>() ?? throw new ArgumentException("resourceId
    var projectId = args["projectId"]?.Value<int>() ?? throw new ArgumentException("projectId req
...
{
    var resourceId = args["resourceId"]?.Value<int>() ?? throw new ArgumentException("resourceId
    var customerId = args["customerId"]?.Value<int>() ?? throw new ArgumentException("customerId
...
    sb.AppendLine($"  Connections: {summary["totalConnections"] ?? 0} ({summary["connectedCount"]
...
        {
            var memGb = (summary["totalMemoryBytes"]?.Value<long>() ?? 0) / 1024.0 / 1024.0 / 102
            sb.AppendLine($"  Memory: {memGb:F1} GB");
        }
        if (summary["totalStorageBytes"] != null)
        {
            var storTb = (summary["totalStorageBytes"]?.Value<long>() ?? 0) / 1024.0 / 1024.0 / 1
...
    var connectionsResponse = await server.Http.GetAsync("/api/infrastructure/connections?onlyAct
    if (!connectionsResponse.IsSuccessStatusCode)
        throw new Exception($"Failed to get infrastructure status: {connectionsResponse.StatusCod
...
        {
            sb.AppendLine($"- [{conn["integrationType"]}] {conn["name"]}: {conn["lastError"] ?? "
        }
    }
...
    var namespaces = args["namespaces"]?.ToObject<List<string>>() ?? new List<string> { "served",

    // Get connection by slug
    var connResponse = await server.Http.GetAsync($"/api/infrastructure/connections/slug/{connect
...
    var connResponse = await server.Http.GetAsync("/api/infrastructure/connections?onlyActive=tru
    if (!connResponse.IsSuccessStatusCode)
...
    var dbConnections = connections.Where(c => dbTypes.Contains(c["integrationType"]?.ToString()?
...
            try
            {
                var metricsResponse = await server.Http.GetAsync($"/api/infrastructure/connection
...
    sb.AppendLine($"Endpoint: {conn["endpoint"]}");
    sb.AppendLine($"Status: {(conn["isConnected"]?.Value<bool>() == true ? "✅ Connected" : "❌ D
    sb.AppendLine();

    // Get VMs
    try
    {
        var vmsResponse = await server.Http.GetAsync($"/api/infrastructure/connections/{connectio
...
                    sb.AppendLine($"     Memory: {memPct:F1}% ({memUsage / 1024 / 1024 / 1024:F1}
                }
            }
            sb.AppendLine();
        }
...
    try
    {
        var lxcResponse = await server.Http.GetAsync($"/api/infrastructure/connections/{connectio
...
            sb.AppendLine($"{(isHealthy ? "✅" : "❌")} {serviceName}: {(isHealthy ? "Healthy" :
        }
        catch (Exception ex)
        {
...
                var isHealthy = response.IsSuccessStatusCode;
                sb.AppendLine($"{(isHealthy ? "✅" : "❌")} {service.Key}: {(isHealthy ? "Healthy
            }
            catch (Exception ex)
            {
...
{
    var agentId = args["agentId"]?.Value<string>() ?? throw new ArgumentException("agentId requir
...
{
    var agentId = args["agentId"]?.Value<string>() ?? throw new ArgumentException("agentId requir
    var taskDescription = args["task"]?.Value<string>() ?? throw new ArgumentException("task requ
...
    var response = await server.Http.PostAsync($"/api/cli-agents/Kill{queryParams}&agentId={agent
...
    var response = await server.Http.PostAsync($"/api/cli-agents/KillOverBudget{queryParams}", nu
...
{
    var agentType = args["agentType"]?.Value<string>() ?? throw new ArgumentException("agentType
    var force = args["force"]?.Value<bool>() ?? false;
...
    var queryParams = new List<string>();
    if (!string.IsNullOrEmpty(workflowType)) queryParams.Add($"type={Uri.EscapeDataString(workflo
...
                    sb.AppendLine($"     Patterns: {string.Join(", ", patterns.Select(p => p.ToSt
            }
        }
        sb.AppendLine();
    }
...
{
    var workflowId = args["workflowId"]?.Value<string>() ?? throw new ArgumentException("workflow
...
    var content = new StringContent(payload.ToString(), Encoding.UTF8, "application/json");
    var response = await server.Http.PostAsJsonAsync($"/api/automation/workflows/{workflowId}/exe
...
    if (!string.IsNullOrEmpty(workflowId)) queryParams.Add($"workflowId={Uri.EscapeDataString(wor
    if (!string.IsNullOrEmpty(status)) queryParams.Add($"status={Uri.EscapeDataString(status)}");
    url += "?" + string.Join("&", queryParams);
...
    var content = new StringContent(payload.ToString(), Encoding.UTF8, "application/json");
    var response = await server.Http.PatchAsync($"/api/automation/workflows/{workflowId}", conten
...
    "FIRST TOOL TO CALL! Returns current user info, available tenants and workspaces. Essential f
    async (args) =>
    {
...
        {
            sb.AppendLine($"    @tenant[{tenant["id"]}] {{ name: \"{tenant["name"]}\", slug: \"{t
        }
        sb.AppendLine("  }");
        sb.AppendLine();
...
        {
            sb.AppendLine($"    @workspace[{ws["id"]}] {{ name: \"{ws["name"]}\", slug: \"{ws["sl
        }
        sb.AppendLine("  }");
        sb.AppendLine("}");
...
    async (args) =>
    {
        var tenantId = args["tenantId"]?.Value<int>() ?? throw new ArgumentException("tenantId re
...
        sb.AppendLine($"  features: [{string.Join(", ", (tenant["features"] as JArray ?? new JArr
        sb.AppendLine();
...
        ["properties"] = new JObject
        {
            ["tenantId"] = new JObject { ["type"] = "integer", ["description"] = "Tenant ID to ge
        },
...
    async (args) =>
    {
        var projectId = args["projectId"]?.Value<int>() ?? throw new ArgumentException("projectId
...
        var tasksResponse = await server.Http.GetAsync($"/api/tasks?projectId={projectId}&limit=5
        var tasks = tasksResponse.IsSuccessStatusCode
            ? JObject.Parse(await tasksResponse.Content.ReadAsStringAsync())["data"] as JArray ??
            : new JArray();
...
        sb.AppendLine($"    {status} @task[{task["id"]}] {{ name: \"{task["name"]}\", progress: {
    }
...
    var response = await server.Http.PostAsJsonAsync($"/api/agents/coordination/GetAgentContext?a
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
    sb.AppendLine($"  progress: {completed}/{todos.Count} ({(todos.Count > 0 ? completed * 100 /
    sb.AppendLine();
...
{
    var agentId = args["agentId"]?.Value<int>() ?? throw new ArgumentException("agentId required"
    var content = args["content"]?.Value<string>() ?? throw new ArgumentException("content requir
...
    var response = await server.Http.PostAsJsonAsync($"/api/agents/coordination/AddTodo?agentId={
...
    var status = args["status"]?.Value<string>() ?? throw new ArgumentException("status required
...
    var response = await server.Http.PostAsJsonAsync($"/api/agents/coordination/UpdateTodoStatus?
...
{
    var workspaceId = args["workspaceId"]?.Value<int>() ?? throw new ArgumentException("workspace
...
{
    var canvasId = args["canvasId"]?.Value<int>() ?? throw new ArgumentException("canvasId requir
...
        {
            "Text" or "0" => node["textContent"]?.ToString()?.Substring(0, Math.Min(50, node["tex
...
    // Get agent context
    var contextResponse = await server.Http.PostAsJsonAsync($"/api/agents/coordination/GetAgentCo
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
{
    var tenantId = args["tenantId"]?.Value<int>() ?? throw new ArgumentException("tenantId requir

    var response = await server.Http.GetAsync($"/api/tenants/{tenantId}/features/GetModulesWithFe
    if (!response.IsSuccessStatusCode)
...
            sb.AppendLine($"    {marker} @feature[{feature["id"]}] \"{feature["name"]}\"{override

            // Show dependencies if any
            var deps = feature["dependsOnFeatureIds"] as JArray;
            if (deps != null && deps.Count > 0)
            {
                sb.AppendLine($"       → depends on: [{string.Join(", ", deps.Select(d => d.ToStr
            }
        }
        sb.AppendLine($"  }}");
    }
...
{
    var tenantId = args["tenantId"]?.Value<int>() ?? throw new ArgumentException("tenantId requir
    var featureId = args["featureId"]?.Value<int>() ?? throw new ArgumentException("featureId req
...
        {
            sb.AppendLine($"   Also enabled prerequisites: {string.Join(", ", enabledPrereqs.Sele
        }
        return sb.ToString();
    }
    else
...
        {
            sb.AppendLine($"   Blocked by dependents: {string.Join(", ", dependents.Select(d => d
...
{
    var tenantId = args["tenantId"]?.Value<int>() ?? throw new ArgumentException("tenantId requir
    var moduleId = args["moduleId"]?.Value<int>() ?? throw new ArgumentException("moduleId requir
    var force = args["force"]?.Value<bool>() ?? false;
...
        return $"✅ Module {moduleId} disabled for tenant {tenantId} ({disabledCount} features di
    }
    else
    {
        var message = result["message"]?.ToString() ?? "Unknown error";
...
    var response = await server.Http.GetAsync($"/api/tenants/{tenantId}/features/GetPrerequisites
    if (!response.IsSuccessStatusCode)
...
        var marker = isEnabled ? "✓" : "○";
        sb.AppendLine($"    {marker} @feature[{prereq["id"]}] \"{prereq["name"]}\" ({prereq["modu
    }
    sb.AppendLine($"  ]");
    sb.AppendLine("}");
...
    var response = await server.Http.GetAsync($"/api/tenants/{tenantId}/features/GetDependents?fe
    if (!response.IsSuccessStatusCode)
...
            var canOverride = feature["canUserOverride"]?.Value<bool>() == true;
            var overrideHint = canOverride ? "" : " [locked]";
            sb.AppendLine($"      @feature[{feature["id"]}] \"{feature["name"]}\"{defaultHint}{ov
        }
        sb.AppendLine($"    ]");
        sb.AppendLine($"  }}");
    }
...
    var tenantId = args["tenantId"]?.Value<int>() ?? throw new ArgumentException("tenantId requir
    var featureId = args["featureId"]?.Value<int>() ?? throw new ArgumentException("featureId req
    var action = args["action"]?.Value<string>()?.ToLower() ?? throw new ArgumentException("actio
...
            "remove" => $"✅ Feature override removed for tenant {tenantId} (will use plan defaul
...
{
    var tenantId = args["tenantId"]?.Value<int>() ?? throw new ArgumentException("tenantId requir
    var featureIdsToken = args["featureIds"] ?? throw new ArgumentException("featureIds required
...
        sb.AppendLine($"  {marker} feature[{prop.Name}]: {(success ? "enabled" : featureResult?["
    }
...
            sb.AppendLine($"    {marker} @feature[{ov["featureId"]}] \"{ov["featureName"]}\" ({ov
...
            (s["category"]?.ToString() ?? "").Contains(category, StringComparison.OrdinalIgnoreCa
    }
...
{
    var settingId = args["settingId"]?.Value<int>() ?? throw new ArgumentException("settingId req
...
        ["standard"] = new List<int> { 1, 2, 3, 4 },    // Core + Identity + ProjectManagement +
        ["professional"] = new List<int> { 1, 2, 3, 4, 5, 6, 7 }, // + Registration + Finance + R
...
    var featuresResponse = await server.Http.GetAsync($"/api/tenants/{tenantId}/features/GetModul
...
    // Get settings
    var settingsResponse = await server.Http.PostAsJsonAsync("/api/administration/tenant/settings
        new StringContent("{}", Encoding.UTF8, "application/json"));
...
    var enabledFeatures = modules.Sum(m => (m["features"] as JArray)?.Count(f => f["isEnabled"]?.
...
        .Where(m => (m["features"] as JArray)?.Any(f => f["isEnabled"]?.Value<bool>() == true) ==
        .Select(m => m["name"]?.ToString())
        .ToList();
    sb.AppendLine($"    enabledOptionalModules: [{string.Join(", ", enabledOptional.Select(n => $
    sb.AppendLine("  }");
    sb.AppendLine();
...
    {
        return "No project index found. Run 'served build index' in the ServedApp repository to c
    }
...
    {
        if (line.StartsWith("dotnet:")) { inDotnet = true; inNode = false; inSwift = false; conti
        if (line.StartsWith("node:")) { inDotnet = false; inNode = true; inSwift = false; continu
        if (line.StartsWith("swift:")) { inDotnet = false; inNode = false; inSwift = true; contin
...
            if (trimmed.StartsWith("freq:")) currentPattern["freq"] = trimmed.Replace("freq:", ""
            else if (trimmed.StartsWith("severity:")) currentPattern["severity"] = trimmed.Replac
            else if (trimmed.StartsWith("suggestion:")) currentPattern["suggestion"] = trimmed.Re
        }
    }
    if (currentPattern.Count > 0) patterns.Add(currentPattern);
...
    if (patterns.Count == 0)
    {
        sb.AppendLine("No patterns detected yet. Run builds with 'served build watch' to detect p
        return sb.ToString();
    }

    // Sort by frequency
    patterns = patterns.OrderByDescending(p => int.TryParse(p.GetValueOrDefault("freq", "0"), out
...
            var trimmed = line.Trim();
            if (trimmed.StartsWith("p:")) sb.AppendLine($"Path: {trimmed.Replace("p:", "").Tr
            else if (trimmed.StartsWith("fw:")) sb.AppendLine($"Framework: {trimmed.Replace("
            else if (trimmed.StartsWith("t:")) sb.AppendLine($"Project Type: {trimmed.Replace
            else if (trimmed.StartsWith("pm:")) sb.AppendLine($"Package Manager: {trimmed.Rep
            else if (trimmed.StartsWith("deps:")) sb.AppendLine($"Dependencies: {trimmed.Repl
            else if (trimmed.StartsWith("b:")) sb.AppendLine($"Build Status: {trimmed.Replace
        }
    }

    if (!foundProject)
    {
        return $"Project '{projectName}' not found in index. Run 'served build status' to see ava
    }
...
        if (line.StartsWith("patterns:") || line.StartsWith("changes:") || line.StartsWith("activ
        {
...
        sb.AppendLine($"| {b.GetValueOrDefault("p", "-")} | {b.GetValueOrDefault("at", "-")} | {r
    }
...
        sb.AppendLine($"Processing Tags: {string.Join(", ", processingTags.Select(t => t.ToSt
    if (mentions.Count > 0)
    {
...
    if (actionTags.Count == 0 && statusTags.Count == 0 && domainTags.Count == 0 && mentions.Count
    {
...
        sb.AppendLine($"ID: {m["id"]} | Intent: {m["detectedIntent"]} | Status: {m["r
        sb.AppendLine();
...
{
    var mentionId = args["mentionId"]?.Value<long>() ?? throw new ArgumentException("mentionId re
...
    {
        sb.AppendLine($"Enabled Platforms: {string.Join(", ", platforms.Select(p => p.ToStrin
    }
...
{
    var path = args["path"]?.Value<string>() ?? Environment.GetFolderPath(Environment.SpecialFold
...
    if (path.StartsWith("~"))
    {
        path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), pat
    }
...
    {
        ["code"] = new[] { "cs", "ts", "js", "py", "go", "rs", "java", "kt", "swift", "rb", "php"
        ["web"] = new[] { "html", "htm", "css", "scss", "sass", "less", "vue", "jsx", "tsx", "sve
        ["config"] = new[] { "json", "yaml", "yml", "toml", "ini", "conf", "env", "xml", "plist"
        ["docs"] = new[] { "md", "txt", "rst", "doc", "docx", "pdf", "rtf", "odt" },
        ["media"] = new[] { "jpg", "jpeg", "png", "gif", "bmp", "svg", "mp3", "wav", "mp4", "mov"
...
    var excludedPaths = new[] { "node_modules", ".git/objects", "bin/Debug", "bin/Release", "obj/
        ".nuget", ".npm", ".cache", "__pycache__", ".venv", "venv", "dist", "build", ".next", ".t
        "coverage", ".pytest_cache", "DerivedData", "xcuserdata", ".Spotlight-V100", ".fseventsd"

    // Sensitive path patterns
    var sensitivePatterns = new[] { @"\.ssh", @"\.aws", @"\.gnupg", @"Keychains", @"\.env$", @"cr
...
    var allowedPatternRegex = allowPattern != null ? new System.Text.RegularExpressions.Regex(all
...
    {
        if (string.IsNullOrEmpty(s)) return null;
        if (s.EndsWith("d", StringComparison.OrdinalIgnoreCase) && int.TryParse(s[..^1], out var
            return DateTime.Now.AddDays(-days);
        if (s.EndsWith("h", StringComparison.OrdinalIgnoreCase) && int.TryParse(s[..^1], out var
...
    var nameRegex = regex != null ? new System.Text.RegularExpressions.Regex(regex, System.Text.R
...
            {
                if (System.Text.RegularExpressions.Regex.IsMatch(dir, pattern, System.Text.Regula
                {
                    isSensitive = true;
                    break;
                }
...
                            .Replace("\\*", ".*").Replace("\\?", ".") + "$";
                        if (!System.Text.RegularExpressions.Regex.IsMatch(fileName, pattern, Syst
                            continue;
                    }
...
                                if (!content.Contains(contains, StringComparison.OrdinalIgnoreCas
                            }
                            catch { continue; }
                        }
...
                        var pattern = "^" + System.Text.RegularExpressions.Regex.Escape(name)
                            .Replace("\\*", ".*").Replace("\\?", ".") + "$";
                        if (System.Text.RegularExpressions.Regex.IsMatch(dirName, pattern, System
                        {
                            results.Add(new
                            {
                                path = subdir,
...
    {
        "size" => reverse ? results.OrderByDescending(r => ((dynamic)r).size) : results.OrderBy(r
        "name" => reverse ? results.OrderByDescending(r => ((dynamic)r).name) : results.OrderBy(r
        "ext" => reverse ? results.OrderByDescending(r => ((dynamic)r).extension ?? "") : results
        _ => reverse ? results.OrderBy(r => ((dynamic)r).modified) : results.OrderByDescending(r
    };
...
        hint = sensitiveSkipped > 0 ? $"Use 'allow' parameter to access {sensitiveSkipped} sensit
    };
});
...
            sensitivePatterns = new[] { ".ssh", ".aws", ".gnupg", "Keychains", ".env", "credentia
        };
    }
...
{
    var pattern = args["pattern"]?.Value<string>() ?? throw new ArgumentException("pattern requir
...
    var auditEntry = $"[{DateTime.UtcNow:yyyy-MM-dd HH:mm:ss}] ALLOW | {pattern} | {reason} | Use
...
        pattern,
        reason,
        expiresAt = days > 0 ? DateTime.UtcNow.AddDays(days).ToString("yyyy-MM-dd HH:mm:ss") : "N
    };
});
...
    var response = await server.Http.GetAsync($"/api/social/monitoring/mentions?{string.Join("&",
...
        if (mention["draftResponse"] != null && !string.IsNullOrEmpty(mention["draftResponse"]?.V
        {
...
{
    var mentionId = args["mentionId"]?.Value<long>() ?? throw new ArgumentException("mentionId re
    var responseText = args["response"]?.Value<string>() ?? throw new ArgumentException("response

    var payload = new JObject { ["response"] = responseText };
    var httpContent = new StringContent(payload.ToString(), Encoding.UTF8, "application/json");

    var response = await server.Http.PostAsJsonAsync($"/api/social/monitoring/mentions/{mentionId
    response.EnsureSuccessStatusCode();
...
    var response = await server.Http.PostAsync($"/api/social/monitoring/mentions/{mentionId}/acce
    response.EnsureSuccessStatusCode();

    return new { success = true, message = $"Draft response accepted and sent for mention {mentio
});
...
    var response = await server.Http.PostAsync($"/api/social/monitoring/mentions/{mentionId}/skip
    response.EnsureSuccessStatusCode();
...
        sb.AppendLine($"  Content: {item["content"]?.Value<string>()?[..Math.Min(100, item["conte
...
    var response = await server.Http.GetAsync($"/api/analytics/tools/cli/commands?days={days}&lim
    response.EnsureSuccessStatusCode();
...
    var response = await server.Http.GetAsync($"/api/analytics/tools/mcp/tools?days={days}&limit=
    response.EnsureSuccessStatusCode();
...
    var response = await server.Http.GetAsync($"/api/analytics/tools/agents/sessions?days={days}&
    response.EnsureSuccessStatusCode();
...
        sb.AppendLine($"  Duration: {session["totalDurationMs"]}ms | Tools: {session["toolCallCou
...
        sb.AppendLine($"   Name Servers: {string.Join(", ", (zone["name_servers"] as JArray ?? ne
        sb.AppendLine();
    }
...
    return $"✅ DNS record created:\n   {created?["name"]} ({created?["type"]}) → {created?["cont
});
...
            suggestions.Add($"   💡 Recommendation: Consider Cloudflare Load Balancer for high av
        }
...
                        {
                            suggestions.Add($"⚠️ Load Balancer '{lb["name"]}' has no steering poli
                            suggestions.Add($"   💡 Recommendation: Enable geo/latency steering f
                        }
                    }
                }
                else
...
        // Output suggestions
        sb.AppendLine($"DNS Records: {records.Count} total ({proxiedRecords.Count} proxied, {
        sb.AppendLine();
...
{
    var repositoryId = args["repositoryId"]?.Value<int>() ?? throw new ArgumentException("reposit
...
    var request = new JObject
    {
        ["provider"] = args["provider"]?.ToString() ?? throw new ArgumentException("provider requ
        ["repositoryName"] = args["repositoryName"]?.ToString() ?? throw new ArgumentException("r
        ["repositoryUrl"] = args["repositoryUrl"]?.ToString() ?? throw new ArgumentException("rep
        ["accessToken"] = args["accessToken"]?.ToString() ?? throw new ArgumentException("accessT
...
    {
        request["azureOrganization"] = args["azureOrganization"]?.ToString() ?? throw new Argumen
        request["azureProject"] = args["azureProject"]?.ToString() ?? throw new ArgumentException
    }
...
    var request = new JObject
    {
        ["id"] = args["repositoryId"]?.Value<int>() ?? throw new ArgumentException("repositoryId
    };
...
        }).ToList(),
        hint = prs.Count == 0
            ? "No PRs linked to this task. PRs can be linked via 'Fixes SERVED-123' in PR descrip
...
{
    var sessionId = args["sessionId"]?.Value<int>() ?? throw new ArgumentException("sessionId req
...
{
    var pullRequestId = args["pullRequestId"]?.Value<int>() ?? throw new ArgumentException("pullR
    var taskId = args["taskId"]?.Value<int>() ?? throw new ArgumentException("taskId required");

    var request = new JObject { ["taskId"] = taskId };
    var content = new StringContent(request.ToString(), Encoding.UTF8, "application/json");
    var response = await server.Http.PostAsJsonAsync($"/api/devops/pullrequests/{pullRequestId}/l
    response.EnsureSuccessStatusCode();
...
{
    var pullRequestId = args["pullRequestId"]?.Value<int>() ?? throw new ArgumentException("pullR
    var response = await server.Http.GetAsync($"/api/devops/pullrequests/{pullRequestId}/runs/lat
...
{
    var repositoryId = args["repositoryId"]?.Value<int>() ?? throw new ArgumentException("reposit
    var pipelineId = args["pipelineId"]?.Value<long>() ?? throw new ArgumentException("pipelineId

    var response = await server.Http.GetAsync($"/api/devops/repositories/{repositoryId}/pipelines
    response.EnsureSuccessStatusCode();
    var result = JObject.Parse(await response.Content.ReadAsStringAsync());
...
            ? $"❌ {failedJobs.Count} job(s) failed: {string.Join(", ", failedJobs.Select(j => j[
            : "✅ All jobs passed"
    };
});
...
    var response = await server.Http.GetAsync($"/api/devops/repositories/{repositoryId}/jobs/{job
    response.EnsureSuccessStatusCode();
...
        log = string.Join("\n", lastLines),
        hint = lines.Length > tail ? $"Showing last {tail} lines. Use 'tail' parameter to get mor
    };
});
...
    var response = await server.Http.PostAsync($"/api/devops/repositories/{repositoryId}/jobs/{jo
    response.EnsureSuccessStatusCode();
...
    {
        agents = agents.Split(',', StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.Tri
...
    var response = await server.Http.PostAsJsonAsync("/api/agents/supervisor/stop", new { gracefu
...
    var response = await server.Http.PostAsJsonAsync($"/api/agents/supervisor/plan/{action}", new
...
    var response = await server.Http.PostAsJsonAsync($"/api/agents/{agentId}/{action}", new { for
...
{
    var question = args["question"]?.Value<string>() ?? throw new ArgumentException("question req
    var optionsArray = args["options"] as JArray ?? throw new ArgumentException("options required
...
    // Wait for response
    var waitResponse = await server.Http.GetAsync($"/api/atlas/request/{requestId}/wait?timeout={
...
{
    var message = args["message"]?.Value<string>() ?? throw new ArgumentException("message requir
...
{
    var requestId = args["requestId"]?.Value<string>() ?? throw new ArgumentException("requestId
    var response = args["response"]?.Value<string>() ?? throw new ArgumentException("response req
...
    var httpResponse = await server.Http.PostAsJsonAsync($"/api/atlas/request/{requestId}/respond
...
// ----------------------------------------------------------------------
// Atlas Computer Control Tools (via IntelligenceManager on localhost:6943)
// These tools give Atlas the ability to see and control Eden (Thomas' Mac)
// ----------------------------------------------------------------------

var atlasControlBaseUrl = "http://localhost:6943";
var atlasControlHttp = new HttpClient { BaseAddress = new Uri(atlasControlBaseUrl), Timeout = Tim

server.RegisterTool("AtlasControlHealth", async (args) =>
{
    try
    {
        var response = await atlasControlHttp.GetStringAsync("/atlas/health");
        return response;
    }
    catch (Exception ex)
    {
        return new { success = false, error = $"Atlas Control not available: {ex.Message}", hint
    }
});

server.RegisterTool("AtlasListWindows", async (args) =>
{
    try
    {
        var response = await atlasControlHttp.GetStringAsync("/atlas/windows");
        return response;
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasFocusWindow", async (args) =>
{
...
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/windows/focus", dto);
...
server.RegisterTool("AtlasScreenshot", async (args) =>
{
    var windowId = args["windowId"]?.Value<int?>();
    var appName = args["appName"]?.Value<string>();
...
        var response = await atlasControlHttp.PostAsJsonAsync(endpoint, dto);
        var result = await response.Content.ReadAsStringAsync();

        // The response includes base64 PNG data
        return result;
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasMouseMove", async (args) =>
{
...
    try
    {
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/mouse/move", new { x, y, sm
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasMouseClick", async (args) =>
{
    var x = args["x"]?.Value<double>() ?? throw new ArgumentException("x required");
    var y = args["y"]?.Value<double>() ?? throw new ArgumentException("y required");
...
        var response = await atlasControlHttp.PostAsJsonAsync(endpoint, new { x, y });
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasType", async (args) =>
{
    var text = args["text"]?.Value<string>() ?? throw new ArgumentException("text required");

    try
    {
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/keyboard/type", new { text
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasKeyPress", async (args) =>
{
    var key = args["key"]?.Value<string>() ?? throw new ArgumentException("key required");

    try
    {
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/keyboard/key", new { key })
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasKeyboardShortcut", async (args) =>
{
    var shortcut = args["shortcut"]?.Value<string>() ?? throw new ArgumentException("shortcut req

    try
    {
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/keyboard/shortcut", new { s
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasShowPointer", async (args) =>
{
    var x = args["x"]?.Value<double>() ?? throw new ArgumentException("x required");
    var y = args["y"]?.Value<double>() ?? throw new ArgumentException("y required");
...
    try
    {
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/pointer/show", new { x, y,
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasHidePointer", async (args) =>
{
    try
    {
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/pointer/hide", new { });
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
server.RegisterTool("AtlasMovePointer", async (args) =>
{
    var x = args["x"]?.Value<double>() ?? throw new ArgumentException("x required");
    var y = args["y"]?.Value<double>() ?? throw new ArgumentException("y required");
...
    try
    {
        var response = await atlasControlHttp.PostAsJsonAsync("/atlas/pointer/move", new { x, y }
        return await response.Content.ReadAsStringAsync();
    }
    catch (Exception ex)
    {
...
// ----------------------------------------------------------------------
// Atlas Squad Agent Tools
// ----------------------------------------------------------------------

server.RegisterTool("GetAgents", async (args) =>
{
    var agents = await client.Agents.GetAllAsync();
    return ResponseFormatter.Create()
        .CountHeader(agents.Count, "agent", "agents")
        .EntityList("agent", agents, a => a.Id, (f, a) =>
        {
            f.PropString("name", a.Name)
             .PropStringIfNotEmpty("symbol", a.Symbol)
             .PropString("role", a.Role)
             .PropString("sessionKey", a.SessionKey)
             .PropString("status", a.Status.ToString())
             .PropString("level", a.Level.ToString())
             .Prop("currentTaskId", a.CurrentTaskId)
             .PropStringIfNotEmpty("currentTaskName", a.CurrentTaskName)
             .PropBool("isOnline", a.IsOnline);
        })
        .ToString();
});
...
server.RegisterTool("GetAgentDetails", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var agent = await client.Agents.GetAsync(agentId);
...
            .PropString("name", agent.Name)
            .PropStringIfNotEmpty("symbol", agent.Symbol)
            .PropString("role", agent.Role)
            .PropString("sessionKey", agent.SessionKey)
            .PropString("status", agent.Status.ToString())
            .PropString("level", agent.Level.ToString())
            .Prop("userId", agent.UserId)
            .Prop("currentTaskId", agent.CurrentTaskId)
            .PropStringIfNotEmpty("currentTaskName", agent.CurrentTaskName)
            .PropStringIfNotEmpty("soulPath", agent.SoulPath)
            .PropList("specializations", agent.Specializations)
            .PropList("capabilities", agent.Capabilities)
            .PropDateTime("lastHeartbeat", agent.LastHeartbeat)
            .PropBool("isOnline", agent.IsOnline)
        .EndEntity()
        .ToString();
});

server.RegisterTool("GetAgentBySessionKey", async (args) =>
{
    var sessionKey = args.GetRequiredString("sessionKey");
    var agent = await client.Agents.GetBySessionKeyAsync(sessionKey);

    if (agent == null)
        return $"Agent with session key '{sessionKey}' not found.";
...
server.RegisterTool("UpdateAgentStatus", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var status = args.GetRequiredEnum<Served.SDK.Models.Agents.AgentStatus>("status");

    var agent = await client.Agents.UpdateStatusAsync(agentId, status);
    return ResponseFormatter.Create()
        .Success($"Agent {agent.Name} status updated to {status}")
        .ToString();
});

server.RegisterTool("AgentHeartbeat", async (args) =>
{
    int? agentId = args.GetOptionalIntOrNull("agentId");
    string? sessionKey = args.GetOptionalString("sessionKey");

    Served.SDK.Models.Agents.HeartbeatResult result;
    if (agentId.HasValue)
    {
        result = await client.Agents.HeartbeatAsync(agentId.Value);
    }
    else if (!string.IsNullOrEmpty(sessionKey))
    {
        result = await client.Agents.HeartbeatBySessionKeyAsync(sessionKey);
    }
    else
    {
        throw new ArgumentException("Either agentId or sessionKey is required");
    }

    var f = ResponseFormatter.Create()
        .Header($"HEARTBEAT: {result.AgentName}")
        .Line()
        .PropString("status", result.Status)
        .PropBool("hasWork", result.HasWork)
        .PropDateTime("executedAt", result.ExecutedAt);

    if (result.PendingNotifications.Any())
    {
        f.Line()
         .Header($"Pending Notifications ({result.PendingNotifications.Count}):");
        foreach (var n in result.PendingNotifications)
        {
            f.Bullet($"From {n.FromAgentName ?? n.FromUserName ?? "Unknown"}: {n.Content}");
        }
    }

    if (result.AssignedTasks.Any())
    {
        f.Line()
         .Header($"Assigned Tasks ({result.AssignedTasks.Count}):");
        foreach (var t in result.AssignedTasks)
        {
            f.Bullet($"[{t.Id}] {t.Name} ({t.Status})");
        }
    }

    if (result.WorkingMemory != null)
    {
        f.Line()
         .Header("Working Memory:")
         .PropStringIfNotEmpty("currentTask", result.WorkingMemory.CurrentTask)
         .PropStringIfNotEmpty("status", result.WorkingMemory.Status);
        if (result.WorkingMemory.NextSteps.Any())
        {
            f.Line().Header("Next Steps:");
            foreach (var step in result.WorkingMemory.NextSteps)
            {
                f.Bullet(step);
            }
        }
...
server.RegisterTool("GetWorkingMemory", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var memory = await client.Agents.GetWorkingMemoryAsync(agentId);

    if (memory == null)
        return "No working memory found for this agent.";

    return ResponseFormatter.Create()
        .Header("Working Memory")
        .PropStringIfNotEmpty("currentTask", memory.CurrentTask)
        .PropStringIfNotEmpty("status", memory.Status)
        .PropStringIfNotEmpty("context", memory.Context)
        .PropDateTime("lastUpdated", memory.LastUpdated)
        .Line()
        .Header("Next Steps:")
        .ForEach(memory.NextSteps, (f, step) => f.Bullet(step))
        .ToString();
});

server.RegisterTool("UpdateWorkingMemory", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var request = new Served.SDK.Models.Agents.UpdateWorkingMemoryRequest
    {
        CurrentTask = args.GetOptionalString("currentTask"),
        Status = args.GetOptionalString("status"),
        NextSteps = args.Has("nextSteps") ? args.GetStringList("nextSteps") : null,
        Context = args.GetOptionalString("context")
    };

    var memory = await client.Agents.UpdateWorkingMemoryAsync(agentId, request);
    return ResponseFormatter.Create()
        .Success("Working memory updated")
        .PropStringIfNotEmpty("currentTask", memory.CurrentTask)
        .PropStringIfNotEmpty("status", memory.Status)
        .ToString();
});
...
server.RegisterTool("GetActivityFeed", async (args) =>
{
    var agentId = args.GetOptionalIntOrNull("agentId");
    var taskId = args.GetOptionalIntOrNull("taskId");
    var limit = args.GetOptionalInt("limit", 20);

    var query = new Served.SDK.Models.Agents.ActivityQueryParams
    {
        AgentId = agentId,
        TaskId = taskId,
        Take = limit
...
    var activities = await client.Agents.GetActivityFeedAsync(query);

    return ResponseFormatter.Create()
        .CountHeader(activities.Count, "activity", "activities")
        .ForEach(activities, (f, a) =>
        {
            var actor = a.AgentName ?? a.UserName ?? "System";
            var symbol = a.AgentSymbol != null ? $" {a.AgentSymbol}" : "";
            f.Line($"[{a.Timestamp:HH:mm}] {actor}{symbol}: {a.Message}");
            if (a.TaskName != null)
                f.Line($"         Task: {a.TaskName}");
        })
        .ToString();
});

server.RegisterTool("LogActivity", async (args) =>
{
    var type = args.GetRequiredEnum<Served.SDK.Models.Agents.ActivityType>("type");
    var message = args.GetRequiredString("message");
    var agentId = args.GetOptionalIntOrNull("agentId");
    var taskId = args.GetOptionalIntOrNull("taskId");

    var request = new Served.SDK.Models.Agents.CreateActivityRequest
    {
        Type = type,
        Message = message,
        AgentId = agentId,
...
    var activity = await client.Agents.LogActivityAsync(request);
    return ResponseFormatter.Create()
        .Success("Activity logged")
        .Prop("id", activity.Id)
        .PropString("type", activity.Type.ToString())
        .PropString("message", activity.Message)
        .ToString();
});
...
server.RegisterTool("GetPendingNotifications", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var notifications = await client.Agents.GetPendingNotificationsAsync(agentId);

    if (!notifications.Any())
        return "No pending notifications.";

    return ResponseFormatter.Create()
        .CountHeader(notifications.Count, "notification", "notifications")
        .EntityList("notification", notifications, n => n.Id, (f, n) =>
        {
            f.PropString("from", n.FromAgentName ?? n.FromUserName ?? "Unknown")
             .PropString("content", n.Content)
             .PropStringIfNotEmpty("taskName", n.TaskName)
             .PropDateTime("createdAt", n.CreatedAt);
        })
        .ToString();
});

server.RegisterTool("SendMention", async (args) =>
{
    var toAgentId = args.GetRequiredInt("toAgentId");
    var content = args.GetRequiredString("content");
    var fromAgentId = args.GetOptionalIntOrNull("fromAgentId");
    var taskId = args.GetOptionalIntOrNull("taskId");

    var request = new Served.SDK.Models.Agents.CreateNotificationRequest
    {
...
    var notification = await client.Agents.CreateNotificationAsync(request);
    return ResponseFormatter.Create()
        .Success($"Mention sent to {notification.MentionedAgentName}")
        .Prop("notificationId", notification.Id)
        .ToString();
});

server.RegisterTool("ParseAndNotify", async (args) =>
{
    var content = args.GetRequiredString("content");
    var taskId = args.GetOptionalIntOrNull("taskId");
    var fromAgentId = args.GetOptionalIntOrNull("fromAgentId");

    var request = new Served.SDK.Models.Agents.ParseMentionsRequest
    {
        Content = content,
        TaskId = taskId,
        FromAgentId = fromAgentId
...
    var notifications = await client.Agents.ParseAndNotifyAsync(request);

    if (!notifications.Any())
        return "No @mentions found in content.";

    return ResponseFormatter.Create()
        .Success($"Created {notifications.Count} notifications from @mentions")
        .ForEach(notifications, (f, n) => f.Bullet($"@{n.MentionedAgentName}"))
        .ToString();
});

server.RegisterTool("MarkNotificationsDelivered", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    await client.Agents.MarkAllDeliveredAsync(agentId);
    return ResponseFormatter.Create()
        .Success("All pending notifications marked as delivered")
        .ToString();
});
...
server.RegisterTool("GenerateStandup", async (args) =>
{
    var dateStr = args.GetOptionalString("date");
    DateTime? date = string.IsNullOrEmpty(dateStr) ? null : DateTime.Parse(dateStr);

    var standup = await client.Agents.GenerateStandupAsync(date);

    var f = ResponseFormatter.Create()
        .Header($"DAILY STANDUP — {standup.Date:yyyy-MM-dd}")
        .Line();

    if (standup.CompletedToday.Any())
    {
        f.Header("COMPLETED TODAY");
        foreach (var task in standup.CompletedToday)
        {
            f.Bullet($"{task.AssignedAgent ?? "Unassigned"}: {task.Name}");
        }
        f.Line();
    }

    if (standup.InProgress.Any())
    {
        f.Header("IN PROGRESS");
        foreach (var task in standup.InProgress)
        {
            f.Bullet($"{task.AssignedAgent ?? "Unassigned"}: {task.Name}");
        }
        f.Line();
...
    if (standup.Blocked.Any())
    {
        f.Header("BLOCKED");
        foreach (var task in standup.Blocked)
        {
            f.Bullet($"{task.AssignedAgent ?? "Unassigned"}: {task.Name}");
            if (!string.IsNullOrEmpty(task.Notes))
                f.Line($"         Reason: {task.Notes}");
        }
        f.Line();
    }

    if (standup.NeedsReview.Any())
    {
        f.Header("NEEDS REVIEW");
        foreach (var task in standup.NeedsReview)
        {
            f.Bullet($"{task.Name}");
        }
        f.Line();
...
    if (standup.KeyDecisions.Any())
    {
        f.Header("KEY DECISIONS");
        foreach (var decision in standup.KeyDecisions)
        {
            f.Bullet(decision);
        }
        f.Line();
...
    if (standup.AgentSummaries.Any())
    {
        f.Header("AGENT STATUS");
        foreach (var agent in standup.AgentSummaries)
        {
            f.Line($"  {agent.AgentName}: {agent.Status} | Completed: {agent.TasksCompleted} | He
            if (!string.IsNullOrEmpty(agent.CurrentWork))
                f.Line($"         Working on: {agent.CurrentWork}");
        }
    }
...
// ----------------------------------------------------------------------
// Dirigent (Conductor) Tools - Orchestration Layer
// "Like an orchestra, each agent has its part to play, but only through
// the conductor do they create harmony."
// ----------------------------------------------------------------------

server.RegisterTool("GetConductorView", async (args) =>
{
    var view = await client.Agents.GetConductorViewAsync();

    var f = ResponseFormatter.Create()
        .Header("🎼 CONDUCTOR VIEW")
        .Line()
        .Header("Orchestra Status")
        .Prop("totalAgents", view.Stats?.TotalAgents ?? 0)
        .Prop("activeAgents", view.Stats?.ActiveAgents ?? 0)
        .PropBool("hasConflicts", view.Coordination?.ActiveConflicts?.Any() == true)
        .PropStringIfNotEmpty("summary", view.Summary)
        .Line();

    if (view.Agents?.Any() == true)
    {
        f.Header("Agents:");
        foreach (var agent in view.Agents)
        {
            f.Line($"  {agent.Symbol ?? "?"} {agent.Name} | {agent.Status} | {(agent.IsOnline ? "
            if (!string.IsNullOrEmpty(agent.CurrentTaskName))
                f.Line($"    └─ Working: {agent.CurrentTaskName}");
        }
        f.Line();
    }

    if (view.RecentActivity?.Any() == true)
    {
        f.Header("Recent Activity:");
        foreach (var activity in view.RecentActivity.Take(5))
        {
            f.Bullet($"{activity.AgentName}: {activity.Type} - {activity.Message}");
        }
        f.Line();
    }

    if (view.Coordination?.ActiveConflicts?.Any() == true)
    {
        f.Header("⚠️ Active Conflicts:");
        foreach (var conflict in view.Coordination.ActiveConflicts)
        {
            f.Bullet($"{conflict.Type}: {conflict.Description} - {string.Join(", ", conflict.Agen
        }
    }

    if (view.Alerts?.Any() == true)
    {
        f.Line().Header("Alerts:");
...
server.RegisterTool("GetCoordinationStatus", async (args) =>
{
    var status = await client.Agents.GetCoordinationStatusAsync();

    var f = ResponseFormatter.Create()
        .Header("SQUAD COORDINATION STATUS")
        .Line()
        .PropDateTime("generatedAt", status.GeneratedAt)
        .Prop("activeAgentCount", status.ActiveAgentCount);

    if (status.ActiveAgents?.Any() == true)
    {
        f.Line().Header("Active Agents:");
        foreach (var agent in status.ActiveAgents)
        {
            f.Line($"  {agent.Name} ({agent.Status})");
            if (!string.IsNullOrEmpty(agent.CurrentTaskName))
                f.Line($"    Task: {agent.CurrentTaskName}");
        }
    }

    if (status.FilesInUse?.Any() == true)
    {
        f.Line().Header("Files In Use:");
        foreach (var file in status.FilesInUse)
        {
            f.Bullet($"{file.FilePath} - by {file.AgentName} ({file.Operation})");
        }
    }

    if (status.TaskAssignments?.Any() == true)
    {
        f.Line().Header("Task Assignments:");
        foreach (var task in status.TaskAssignments)
        {
            f.Bullet($"[{task.TaskId}] {task.TaskName} → {task.AgentName}");
        }
    }

    if (status.ActiveConflicts?.Any() == true)
    {
        f.Line().Header("⚠️ Active Conflicts:");
        foreach (var conflict in status.ActiveConflicts)
        {
            f.Bullet($"{conflict.Type}: {conflict.Description}");
        }
    }
...
server.RegisterTool("DetectConflicts", async (args) =>
{
    var conflicts = await client.Agents.DetectConflictsAsync();

    if (!conflicts.Any())
    {
        return ResponseFormatter.Create()
            .Success("No conflicts detected. All agents working in harmony. 🎵")
            .ToString();
    }

    var f = ResponseFormatter.Create()
        .Header($"⚠️ CONFLICTS DETECTED ({conflicts.Count})")
        .Line();

    foreach (var conflict in conflicts)
    {
        f.Line($"Type: {conflict.Type}")
         .Line($"Description: {conflict.Description}")
         .Line($"Agents: {string.Join(", ", conflict.AgentNames)}")
         .PropString("severity", conflict.Severity)
         .PropStringIfNotEmpty("filePath", conflict.FilePath)
         .PropStringIfNotEmpty("branch", conflict.Branch)
         .Line();
    }
...
server.RegisterTool("SearchContext", async (args) =>
{
    var query = args.GetRequiredString("query");
    var agentId = args.GetOptionalIntOrNull("agentId");
    var limit = args.GetOptionalInt("limit", 10);

    var results = await client.Agents.SearchContextAsync(query, agentId, limit);

    if (!results.Any())
    {
        return ResponseFormatter.Create()
            .Line($"No context found for query: \"{query}\"")
            .ToString();
    }

    var f = ResponseFormatter.Create()
        .Header($"CONTEXT SEARCH: \"{query}\"")
        .CountHeader(results.Count, "result", "results")
        .Line();

    foreach (var result in results)
    {
        f.Line($"[{result.Source}] Score: {result.RelevanceScore:F2}")
         .PropStringIfNotEmpty("text", result.Text?.Length > 200 ? result.Text.Substring(0, 200)
         .PropStringIfNotEmpty("path", result.Path)
         .Line();
    }
...
server.RegisterTool("GetTaskContext", async (args) =>
{
    var taskId = args.GetRequiredInt("taskId");
    var context = await client.Agents.GetTaskContextAsync(taskId);

    var f = ResponseFormatter.Create()
        .Header($"TASK CONTEXT: [{taskId}] {context.TaskName}")
        .Line();

    if (context.SubscribedAgents?.Any() == true)
    {
        f.Header("Subscribed Agents:");
        foreach (var agent in context.SubscribedAgents)
        {
            f.Bullet($"{agent.Name} ({agent.Status})");
        }
        f.Line();
    }

    if (context.ActiveAgents?.Any() == true)
    {
        f.Header("Active Agents:");
        foreach (var agent in context.ActiveAgents)
        {
            f.Bullet($"{agent.Name} ({agent.Status})");
        }
        f.Line();
...
    if (context.RecentActivity?.Any() == true)
    {
        f.Header("Recent Activity:");
        foreach (var activity in context.RecentActivity.Take(5))
        {
            f.Bullet($"{activity.AgentName}: {activity.Type} - {activity.Message}");
        }
        f.Line();
...
    if (context.RelevantMemory?.Any() == true)
    {
        f.Header("Relevant Memory:");
        foreach (var memory in context.RelevantMemory.Take(3))
        {
            var textPreview = memory.Text?.Length > 100 ? memory.Text.Substring(0, 100) + "..." :
            f.Bullet($"[{memory.Source}] {textPreview}");
        }
        f.Line();
    }

    if (context.FilesInUse?.Any() == true)
    {
        f.Header("Files In Use:");
        foreach (var file in context.FilesInUse)
        {
            f.Bullet($"{file.FilePath} - {file.AgentName} ({file.Operation})");
        }
    }
...
server.RegisterTool("GetAgentFullContext", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var context = await client.Agents.GetAgentFullContextAsync(agentId);

    var f = ResponseFormatter.Create()
        .Header($"AGENT CONTEXT: {context.Name} {context.Symbol}")
        .Line();

    if (context.Summary != null)
    {
        f.PropString("status", context.Summary.Status.ToString())
         .PropString("level", context.Summary.Level.ToString())
         .PropBool("isOnline", context.Summary.IsOnline)
         .PropStringIfNotEmpty("currentTask", context.Summary.CurrentTaskName)
         .Line();
    }

    if (context.WorkingMemory != null)
    {
        f.Header("Working Memory:")
         .PropStringIfNotEmpty("currentTask", context.WorkingMemory.CurrentTask)
         .PropStringIfNotEmpty("status", context.WorkingMemory.Status);
        if (context.WorkingMemory.NextSteps?.Any() == true)
        {
            f.Line().Header("Next Steps:");
            foreach (var step in context.WorkingMemory.NextSteps)
            {
                f.Bullet(step);
            }
        }
...
    if (context.PendingNotifications?.Any() == true)
    {
        f.Header($"Pending Notifications ({context.PendingNotifications.Count}):");
        foreach (var n in context.PendingNotifications)
        {
            f.Bullet($"From {n.FromAgentName ?? "Unknown"}: {n.Content}");
        }
        f.Line();
    }

    if (context.TaskSubscriptions?.Any() == true)
    {
        f.Header($"Task Subscriptions ({context.TaskSubscriptions.Count}):");
        foreach (var sub in context.TaskSubscriptions)
        {
            f.Bullet($"Task [{sub.TaskId}] ({sub.Reason})");
        }
        f.Line();
    }
...
server.RegisterTool("HarmonizedHeartbeat", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var currentActivity = args.GetOptionalString("currentActivity");
    var workingOnFile = args.GetOptionalString("workingOnFile");

    var result = await client.Agents.HarmonizedHeartbeatAsync(agentId, currentActivity, workingOn

    var f = ResponseFormatter.Create()
        .Header($"🎵 HARMONIZED HEARTBEAT: {result.AgentName}")
        .Line()
        .PropBool("success", result.Success)
        .PropBool("contextUpdated", result.ContextUpdated)
        .PropBool("hasConflicts", result.Conflicts?.Any() == true);

    if (result.SquadHeartbeat != null)
    {
        f.Line().Header("Squad Heartbeat:")
         .PropString("status", result.SquadHeartbeat.Status)
         .PropBool("hasWork", result.SquadHeartbeat.HasWork);
    }

    if (result.Conflicts?.Any() == true)
    {
        f.Line().Header("⚠️ Conflicts Detected:");
...
    if (result.SquadHeartbeat?.PendingNotifications?.Any() == true)
    {
        f.Line().Header($"Pending Notifications ({result.SquadHeartbeat.PendingNotifications.Coun
        foreach (var n in result.SquadHeartbeat.PendingNotifications)
        {
            f.Bullet($"From {n.FromAgentName ?? "Unknown"}: {n.Content}");
        }
    }

    if (result.RelevantMemory?.Any() == true)
    {
        f.Line().Header("Relevant Memory:");
        foreach (var memory in result.RelevantMemory.Take(3))
        {
            f.Bullet($"[{memory.Source}] {memory.Text?.Substring(0, Math.Min(80, memory.Text?.Len
        }
    }
...
server.RegisterTool("RegisterSession", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var sessionKey = args.GetRequiredString("sessionKey");
    var taskId = args.GetOptionalIntOrNull("taskId");

    var context = await client.Agents.RegisterSessionAsync(agentId, sessionKey, taskId);

    var f = ResponseFormatter.Create()
        .Header($"🎼 SESSION REGISTERED")
        .Line()
        .Prop("agentId", context.AgentId)
        .PropString("sessionKey", context.SessionKey)
        .Prop("taskId", context.TaskId)
        .Prop("cliAgentSessionId", context.CliAgentSessionId);

    if (!string.IsNullOrEmpty(context.WorkingMemory))
    {
        f.Line().Header("Working Memory:")
         .Line(context.WorkingMemory);
    }

    if (!string.IsNullOrEmpty(context.LastSessionSummary))
    {
        f.Line().Header("Last Session Summary:")
         .Line(context.LastSessionSummary);
    }

    if (context.PendingNotifications?.Any() == true)
    {
        f.Line().Header($"Pending Notifications ({context.PendingNotifications.Count}):");
        foreach (var n in context.PendingNotifications)
        {
            f.Bullet($"From {n.FromAgentName ?? "Unknown"}: {n.Content}");
        }
...
    if (context.InitialContext?.Any() == true)
    {
        f.Line().Header("Initial Context:");
        foreach (var memory in context.InitialContext.Take(3))
        {
            f.Bullet($"[{memory.Source}] {memory.Text?.Substring(0, Math.Min(80, memory.Text?.Len
        }
    }
...
server.RegisterTool("EndSession", async (args) =>
{
    var agentId = args.GetRequiredInt("agentId");
    var finalWorkingMemory = args.GetOptionalString("finalWorkingMemory");

    var success = await client.Agents.EndSessionAsync(agentId, finalWorkingMemory);

    return ResponseFormatter.Create()
        .Success(success ? "Session ended gracefully. Context preserved for next wakeup. 😴" : "F
        .ToString();
});

server.RegisterTool("RequestResourceYield", async (args) =>
{
    var targetAgentId = args.GetRequiredInt("targetAgentId");
    var resource = args.GetRequiredString("resource");
    var fromAgentId = args.GetRequiredInt("fromAgentId");
    var reason = args.GetRequiredString("reason");

    var success = await client.Agents.RequestResourceYieldAsync(targetAgentId, resource, fromAgen

    return ResponseFormatter.Create()
        .Line(success ? $"✅ Resource yield request sent for: {resource}" : $"❌ Failed to reques
        .ToString();
});

server.RegisterTool("NotifyTaskUpdate", async (args) =>
{
    var taskId = args.GetRequiredInt("taskId");
    var message = args.GetRequiredString("message");
    var fromAgentId = args.GetOptionalIntOrNull("fromAgentId");

    await client.Agents.NotifyTaskUpdateAsync(taskId, message, fromAgentId);

    return ResponseFormatter.Create()
        .Success($"Task update notification sent for task [{taskId}]")
        .ToString();
});
